...
def register_error_handlers(app: Flask) -> None:
    ...
    def handle_http_exception(e: HTTPException):
        """Handle standard HTTP exceptions, including Webargs/Smorest request schema validation issues."""
        # For Smorest schema validation errors, detail payload is stored in e.data['messages']
        errors = None
